...
With this experiment, we obtain almost the same dynamics coefficients with an error equal to $2.0259\cdot10^{-6}$. The error is smaller than the previous cases; this means that the system has been excited appropriately.
