...
load('data/3-dof/experiment456/Y_stack.mat', 'Y_stack')
load('data/3-dof/experiment456/u_stack.mat', 'u_stack')
load('data/3-dof/experiment456/duration.mat', 'duration')
...
[Y_final_tensor, u_final_tensor, signs_tensor] = tree_3dof_classic(Y1_stack, Y2_stack, Y3_stack, u1_3dof_abs, u2_3dof_abs, u3_3dof_abs, indices1, indices2, indices3, LB, UB);
