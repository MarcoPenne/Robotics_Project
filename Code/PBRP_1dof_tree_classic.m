...
load('data/1-dof/experiment_easy2/Y_stack.mat', 'Y_stack')
load('data/1-dof/experiment_easy2/u_stack.mat', 'u_stack')
load('data/1-dof/experiment_easy2/duration.mat', 'duration')
...
[Y_final_tensor, u_final_tensor, signs_tensor] = tree_1dof_classic(Y_1dof, u_1dof_abs, indices, LB, UB);

Y_estimated = Y_final_tensor{1};
u_estimated_sign = u_final_tensor{1};
%----------------------------------
...
Y_estimated = Y_final_tensor{2};
u_estimated_sign = u_final_tensor{2};
%----------------------------------
% RUN THE TRADITIONAL PBRP ALGORITHM
%----------------------------------
num_of_runs = 3; % independent (parallelizable) runs of the entire algorithm (29)
