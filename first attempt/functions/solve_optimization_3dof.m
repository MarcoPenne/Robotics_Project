function [loss, solution] = solve_optimization_3dof(Y, u, LB, UB, X0)
    ...
    for i=1:num_of_runs
        for SA_step=1:num_of_SA_steps
            ...
            [X,FVAL,EXITFLAG,OUTPUT] = patternsearch(@(x) error_fcn_gM_LMI_regressor_3dof(x, Y, u, SA_step), X0, [], [], [], [],LB,UB,[],options);
